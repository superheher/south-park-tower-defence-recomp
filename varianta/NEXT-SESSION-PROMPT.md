‼️‼️‼️🟢🟢🟢🔗 STATUS 2026-06-06 (cont.39, /loop «go deep renderer job») — ⭐ЗАПИНЕНА цепочка texture-create (кейстоун cont.25 R0): MmAllocate ← sub_824495D8 (генерик-аллокатор) ← **sub_821B0F18 (render-range texture-create)** ← sub_82108xxx. Коммит cont.39 (НЕ пушен). Дефолт-бут НЕ регрессит (RE-итерация). Полностью: NIGHT-LOG «cont.39».
