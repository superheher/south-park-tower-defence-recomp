...
# Codegen target - run 'cmake --build . --target south_park_td_codegen'
# Uses the manifest to drive codegen for all modules (entrypoint + DLLs).
add_custom_target(south_park_td_codegen
    COMMAND $<TARGET_FILE:rex::rexglue> codegen ${CMAKE_CURRENT_SOURCE_DIR}/south_park_td_manifest.toml
    WORKING_DIRECTORY ${CMAKE_CURRENT_SOURCE_DIR}
    COMMENT "Generating recompiled code for south_park_td"
    VERBATIM
)
